...
if(isset($_POST['submit']))
{
	...
	$qty=($qtyl*1000)+$qtyml;
	$pr=($qtyl*$price)+($qtyml*($price/1000));
	$query1="insert into orders(mid,uid,vid,qty,date,price,time,status) values(".$mid.",".$_SESSION['id'].",".$vid.",".$qty.",'".$date."',".$pr.",'".$time."',0)";
    $result1=mysqli_query($con,$query1);
    if($result1)
    {
     	$done=TRUE;
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="table-responsive m-b-40">
                                    <table class="table table-borderless table-data3">
                                        ...
                                        <form action="placeorder.php?vid=<?php echo $vid; ?>&mid=<?php echo $mid;?>" method="POST">
                                            ...
                                            <tr>
                                            	<td colspan="2"><input type="Submit" name="submit" value="Order"></td>
                                            	<td></td>
												<td></td>
												<td></td>
                                            </tr>
                                            <?php
                                                if(isset($done))
                                                {
                                                    ?>
                                                    <tr>
                                                    <td colspan="2"><label>Order Placed Successfully</label>></td>
                                                   <td></td>
                                                   <td></td>
                                                   <td></td>
                                                    </tr>
